  ...
  class Winder
  {
    ...
    private static void Pause()
    {
      ...
      st = "P -> position, W -> wind, E -> end layer, S -> status" 
            + ", V -> toggle VR, T -> terminate, R -> rescue, C -> edit coil.paramz";
      Console.WriteLine(st);
      st = Console.ReadLine();
      ...
      switch (ch)
      {
        ...
        case 'C': // KSG edit: open CoilParameters form to edit coil.paramz
          frm_CoilParameters coilParamz = new frm_CoilParameters(lz);
              ...
              //KSG edit:  the form would freeze upon opening if using coilParamz.Show().  This is method 1 to avoid that
              //begin method 1
