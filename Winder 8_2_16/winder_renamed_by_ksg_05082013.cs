...
namespace WinderProject
{
  class Winder
  {
    ...
    private static void Wind()
    {
      ...
      bool saz_ActiveBreakOn = Bbox.ActiveBreakOn;
    ...
    /*--------------------------------------------------------------------------
     ...
     Called by Position and Wind
    --------------------------------------------------------------------------*/
    public static bool LazySusan()
    {
    ...
    private static void Setup()
    {
      ...
      Mbox.SetFlLimitsP(canFlVel, canFlAcc, stageFlVel, stageFlAcc); // todo sz      //todo no hardware todo  

      // Prepare for button box sampling.
      Bbox.SampleSetup();
      Bbox.SampleTimerSetup(sampleTimeStep);// todo ?? not su
    }  // end Setup
